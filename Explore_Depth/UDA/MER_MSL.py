...
def train(epochs, start_save_epoch, save_epoch, weights=WEIGHTS):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch >= start_save_epoch and epoch % save_epoch == 0:
            ...
            start_time = time.time()
            if MIoU > MIoU_best:
                torch.save(model.state_dict(), '/data5/GLGAN/result_xiugai/MER_MSL/CGA_baoliu_pred1/MER_MSL_epoch{}_{}'.format(epoch, MIoU))
                MIoU_best = MIoU
    print("Train Done!!")
...
model.load_state_dict(torch.load('/data5/GLGAN/result_xiugai/MER_MSL/CGA_baoliu_pred2/MER_MSL_epoch16_0.4916023975360582'))
